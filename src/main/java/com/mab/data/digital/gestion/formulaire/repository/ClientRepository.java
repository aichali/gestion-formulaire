...
public interface ClientRepository extends CrudRepository<Client, Integer> {
    ...
    @Query(value = "SELECT * FROM Client c WHERE c.nom= :nom and c.prenom= :prenom and c.adresse= :adresse and c.cp= :cp and c.adresse_mail=:adressemail and c.tel=:tel", nativeQuery = true)
